...
<div class="panel--body is--wide block-group">
    <label>
        <input type="checkbox" required="required"/> Ik ga akkoord met de <a href="https://www.billink.nl/docs/gebruikersvoorwaarden.pdf" target="_blank">algemene voorwaarden van Billink</a>
    </label>
</div>
